...
enum {
  ...
  SHASHIN_SCORE_KING_SAFE_RATE = 60, SHASHIN_MAX_SCORE_FOR_KING_SAFE_RATE = 80, SHASHIN_MAX_SCORE_KING_SAFE = 380 };
//Various contempt to adapt eventually
enum {
  SHASHIN_DEFAULT_CONTEMPT = 12, SHASHIN_PETROSIAN_CONTEMPT = -6, SHASHIN_CAPABLANCA_CONTEMPT = 12, SHASHIN_CAPABLANCA_PETROSIAN_CONTEMPT = 3,
  SHASHIN_TAL_CONTEMPT = 30, SHASHIN_TAL_PETROSIAN_CONTEMPT = 12, SHASHIN_TAL_CAPABLANCA_CONTEMPT = 21, SHASHIN_TAL_CAPABLANCA_PETROSIAN_CONTEMPT = 12,

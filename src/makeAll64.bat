...
ren shashchess.exe "ShashChess41-x86-64-vnni.exe"
mingw32-make clean
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64-vnni-GoldDigger.exe"
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64-avx512.exe"
mingw32-make clean
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64-avx512-GoldDigger.exe"
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64-bmi2.exe"
mingw32-make clean
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64-avx2.exe"
mingw32-make clean
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64-avx2-GoldDigger.exe"
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64-sse41-popcnt-GoldDigger.exe"
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64-ssse3.exe"
mingw32-make clean
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64-ssse3-GoldDigger.exe"
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64-sse3-popcnt.exe"
mingw32-make clean
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64-sse3-popcnt-GoldDigger.exe"
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64.exe"
mingw32-make clean
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-x86-64-GoldDigger.exe"
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-general-64.exe"
mingw32-make clean
...
strip shashchess.exe
ren shashchess.exe "ShashChess41-general-64-GoldDigger.exe"

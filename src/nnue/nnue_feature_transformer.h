...
template<ShashChess::Eval::NNUE::IndexType TransformedFeatureDimensions>
struct std::hash<ShashChess::Eval::NNUE::FeatureTransformer<TransformedFeatureDimensions>> {
    std::size_t
    operator()(const ShashChess::Eval::NNUE::FeatureTransformer<TransformedFeatureDimensions>& ft)
      const noexcept {

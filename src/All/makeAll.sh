...
strip shashchess
mv 'shashchess' 'ShashChess17-x86-64-vnni'
make clean

make profile-build ARCH=x86-64-avx512 COMP=gcc
strip shashchess
mv 'shashchess' 'ShashChess17-x86-64-avx512'
make clean

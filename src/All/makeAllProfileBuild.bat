...
ren shashchess.exe "ShashChess12.1.2-x86-64-avx512.exe"

Title "x86-64-bmi2"
make clean
mingw32-make profile-build ARCH=x86-64-bmi2 COMP=mingw CXX=x86_64-w64-mingw32-g++ -j %Number_Of_Processors%
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-x86-64-bmi2.exe"

Title "x86-64-avx2"
make clean
mingw32-make profile-build ARCH=x86-64-avx2 COMP=mingw CXX=x86_64-w64-mingw32-g++ -j %Number_Of_Processors%
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-x86-64-avx2.exe"

Title "x86-64-sse42"
make clean
mingw32-make build ARCH=x86-64-sse42 COMP=mingw
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-x86-64-sse42.exe"

Title "x86-64-sse41"
make clean
mingw32-make profile-build ARCH=x86-64-sse41 COMP=mingw CXX=x86_64-w64-mingw32-g++ -j %Number_Of_Processors%
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-x86-64-sse41.exe"
...
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-x86-64-ssse3.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-x86-64-sse3-popcnt.exe"
ren C:\MinGW\mingw64 mingw64-730-pse

Title "x86-64-sse3"
make clean
mingw32-make profile-build ARCH=x86-64-sse3 COMP=mingw CXX=x86_64-w64-mingw32-g++ -j %Number_Of_Processors%
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-x86-64-sse3.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-x86-64.exe"
ren C:\MinGW\mingw64 mingw64-730-pse

Title "ppc-64"
make clean
mingw32-make profile-build ARCH=ppc-64 COMP=mingw CXX=x86_64-w64-mingw32-g++ -j %Number_Of_Processors%
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-ppc-64.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-general-64.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-x86-32.exe"

Title "x86-32-old"
make clean
mingw32-make -f MakeFile profile-build ARCH=x86-32-old COMP=mingw
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-x86-32-old.exe"

Title "ppc-32"
make clean
mingw32-make build ARCH=ppc-32 COMP=mingw
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-ppc-32.exe"

Title "general-32"
make clean
mingw32-make -f MakeFile profile-build ARCH=general-32 COMP=mingw
strip shashchess.exe
ren shashchess.exe "ShashChess12.1.2-general-32.exe"

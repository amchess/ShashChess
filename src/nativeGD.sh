...
# Rinominiamo l'eseguibile per distinguerlo (uniformato a ShashChess41.2)
mv shashchess ShashChess41.2-native-GoldDigger

# Pulizia dei file oggetto intermedi
make clean

echo "Compilazione completata: ShashChess41.2-native-GoldDigger"
...
do
   ...
   echo "$prefix $exeprefix ./shashchess $args $postfix"
   eval "$prefix $exeprefix ./shashchess $args $postfix"

done

# verify the generated net equals the base net
network=`./shashchess uci | grep 'option name EvalFile type string default' | awk '{print $NF}'`
